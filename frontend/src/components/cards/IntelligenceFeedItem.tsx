...
export function IntelligenceFeedItem({ card, onSaveWatchItem, showCompany = true }: Props) {
  ...
  return (
    <article
      ...
      className="group rounded-xl border border-line/60 bg-surface-2/40 px-3 py-3 hover:border-line-strong hover:bg-surface-2 transition-colors cursor-pointer"
    >
        ...
        <div className="flex items-center justify-between gap-2 pt-0.5">
          ...
          {onSaveWatchItem && (
            <button
              ...
              className="btn-ghost px-2 py-1 shrink-0 opacity-90 group-hover:opacity-100"
            >
